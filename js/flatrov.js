...
class Flatrov {
    ...
    gallery = [];
    option;
    constructor(selector, gallery, option) {
    ...
    changeImage(ID) {
        ...
        if (target) {
            let imageWrapper = this.flatrov.querySelector(".flatrov-wrapper")?.querySelector("img");
    ...
    assignThumbnails() {
        ...
        // Add To Fragment
        this.gallery.forEach((item) => container.append(this.createImgThumbnail(item.id, item.imageThumbnail, item.alt)));
